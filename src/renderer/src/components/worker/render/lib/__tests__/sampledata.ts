...
cfg = {
  ...
  mime: 'avc1.640028',
  avcC: makeArray(
    '01 64 00 28 ff e1 00 2e 67 64 00 28 ac 2c a4 01 e0 08 9f 97 ff 00 01 00 01 52 02 02 02 80 00 01 f4 80 00 75 30 73 30 00 13 12 c0 00 0e 4e 1d f8 c7 07 68 58 b4 48 01 00 05 68 eb 73 52 50 fd f8 f8 00'
  ),
  sps: makeArray(
    '67 64 00 28 ac 2c a4 01 e0 08 9f 97 ff 00 01 00 01 52 02 02 02 80 00 01 f4 80 00 75 30 73 30 00 13 12 c0 00 0e 4e 1d f8 c7 07 68 58 b4 48'
  ),
...
cfg = {
  mime: 'avc1.640029',
  avcC: makeArray(
    '01 64 00 29 ff e1 00 18 67 64 00 29 ac 2b 70 50 1e d8 08 80 00 00 03 00 80 00 00 1e 46 d0 e1 97 01 00 04 68 ee 3c b0'
  ),
...
cfg = {
  ...
  mime: 'avc1.640029',
  sps: makeArray(
    '67 64 00 29 ac c8 50 1e 00 89 f9 70 16 a0 20 20 28 00 00 1f 48 00 05 dc 04 78 c1 8c b0'
  ),
